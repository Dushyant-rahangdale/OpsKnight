...
- Automated Slack Incident War-Rooms & `/incident` Slash Commands
- Multi-provider Video War-Rooms (Jitsi Meet, Zoom, Google Meet)
- Team availability & on-call status at a glance
