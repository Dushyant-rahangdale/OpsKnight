...
export async function checkSLABreaches(
    ...
    const resolveWarningThreshold = config.resolveWarningThresholdMs ?? DEFAULT_RESOLVE_WARNING_THRESHOLD_MS;
...
async function notifyBreachWarning(
    ...
    const urgencyEmoji = warning.urgency === 'HIGH' ? '🔴' : warning.urgency === 'MEDIUM' ? '🟡' : '🟢';
