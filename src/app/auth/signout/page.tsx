        ...
        <main className="login-shell" role="main">
            ...
            <div className="login-card glass-panel" style={{
                ...
                <section className="login-form" style={{
                    ...
                    <div className="login-form-logo" style={{ margin: '0 auto 1.5rem', width: '56px', height: '56px' }}>
                        <img src="/logo.svg" alt="OpsSentinal" className="login-form-logo-img" style={{ width: '32px', height: '32px' }} />
                    </div>
