    ...
    return (
      <div className="p-6">
        <div className="mb-6">
          <Link
            href="/postmortems"
            className="text-muted-foreground no-underline text-sm mb-2 inline-block hover:text-foreground transition-colors"
          >
            ← Back to Postmortems
          </Link>
          <h1 className="text-2xl font-bold">Create Postmortem</h1>
