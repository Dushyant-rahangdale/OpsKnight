...
export default function IncidentStatusActions({
    ...
    if (!canManage) {
        return (
            <div style={{ padding: '0.75rem', background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: '0px', opacity: 0.7 }}>
    ...
    return (
        <div style={{ display: 'grid', gap: '0.75rem' }}>
            ...
            <div style={{ display: 'grid', gap: '0.5rem' }}>
                ...
                ) : currentStatus !== 'SUPPRESSED' && currentStatus !== 'RESOLVED' && currentStatus !== 'SNOOZED' && (
            ...
            <div style={{ 
                ...
                <div style={{ fontSize: '0.7rem', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.1em', fontWeight: 600, marginBottom: '0.25rem' }}>
                    Additional Actions
                </div>
                ...
                ) : currentStatus !== 'SUPPRESSED' && currentStatus !== 'RESOLVED' && (
                    <button
                        type="button"
                ...
                ) : currentStatus !== 'SNOOZED' && currentStatus !== 'RESOLVED' && (
