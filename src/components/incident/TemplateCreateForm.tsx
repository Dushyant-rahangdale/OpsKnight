...
export default function TemplateCreateForm({ services, action }: TemplateCreateFormProps) {
    ...
    return (
        <form action={formAction} style={{ display: 'grid', gap: '1.5rem' }}>
            ...
            <div>
                <label htmlFor="description" style={{ display: 'block', marginBottom: '0.5rem', fontWeight: 600, fontSize: '0.9rem' }}>
            ...
            {/* Default Title */}
            <div>
                <label htmlFor="title" style={{ display: 'block', marginBottom: '0.5rem', fontWeight: 600, fontSize: '0.9rem' }}>
            ...
            {/* Default Description */}
            <div>
                <label htmlFor="descriptionText" style={{ display: 'block', marginBottom: '0.5rem', fontWeight: 600, fontSize: '0.9rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                {/* Default Urgency */}
                <div>
                    <label htmlFor="defaultUrgency" style={{ display: 'block', marginBottom: '0.5rem', fontWeight: 600, fontSize: '0.9rem' }}>
                        Default Urgency
                    </label>
                    <select
                        id="defaultUrgency"
                ...
                {/* Default Priority */}
                <div>
                    <label htmlFor="defaultPriority" style={{ display: 'block', marginBottom: '0.5rem', fontWeight: 600, fontSize: '0.9rem' }}>
            ...
            {/* Default Service */}
            <div>
                <label htmlFor="defaultServiceId" style={{ display: 'block', marginBottom: '0.5rem', fontWeight: 600, fontSize: '0.9rem' }}>
