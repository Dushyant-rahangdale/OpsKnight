...
export default function DashboardPeriodComparison({
  ...
  const metrics = [
    ...
    },
    {
      ...
      previous: previous.acknowledged,
  ...
  return (
    <div style={{ padding: '0' }}>
      <div style={{ marginBottom: '1rem', fontSize: '0.85rem', color: 'var(--text-muted)' }}>
        <span style={{ fontWeight: '600' }}>{periodLabel}</span> vs{' '}
        <span style={{ fontWeight: '600' }}>{previousPeriodLabel}</span>
      </div>
      <div
        style={{
          display: 'grid',
